...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($variant->num_rows === 1) {
        ...
        $deleteStmt = $connection->prepare("DELETE FROM product_variants WHERE product_id = ?");
        ...
        $_SESSION['delete-error'] = "More than one variant found for this product. Please check the database.";
        header("Location: add-product-variant.php?id=" . $id);
        exit;
    } else {
